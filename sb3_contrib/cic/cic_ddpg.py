...
class CicDDPG(OffPolicyAlgorithm):
    """
    Contrastive Intrinsic Control (CIC); original DDPG-based version.
    Addressing model-free high-dimensional unsupervised skill learning from pixels.

    Original implementation: https://github.com/rll-research/cic
    Paper: https://arxiv.org/abs/2202.00161, accepted NeurIPS-version: https://openreview.net/forum?id=Z12zA99EFEi
